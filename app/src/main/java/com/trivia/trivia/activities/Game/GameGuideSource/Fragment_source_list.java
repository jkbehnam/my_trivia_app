...
import com.trivia.trivia.adapter.adapter_game_source;
...
public class Fragment_source_list extends BaseFragment {
    ProgressDialog mProgressDialog;
    FragmentActivity c;
    adapter_game_source madapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        name_toolbar.setText("مراجع مسابقه");
...
*/
    ...
    public void setItems(ArrayList<obj_film> eventsList) {
        ...
        madapter = new adapter_game_source(eventsList);
        // SlideInBottomAnimationAdapter alphaAdapter = new SlideInBottomAnimationAdapter(madapter);
        // alphaAdapter.setFirstOnly(true);
        rcle.setAdapter(madapter);
        madapter.setOnCardClickListner(new adapter_game_source.OnCardClickListner() {
            @Override
