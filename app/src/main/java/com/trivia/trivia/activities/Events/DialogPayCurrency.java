...
public class DialogPayCurrency {
    Context context;
    ...
    public AlertDialog init(Context context, String title, String e_id, String money, String score, String u_id) {
        ...
        view_alert_dialog_exit = LayoutInflater.from(context).inflate(R.layout.event_dialog_pay, null);
        ...
        getUserScore(new VolleyCallback() {
            ...
            public void onSuccess(String result) throws JSONException {
                ...
                try {
                    ...
                    if (Integer.parseInt(obj.getString("u_score")) < Integer.parseInt(score)) {
...
//rcl_member=(RecyclerView)view_alert_dialog_exit.findViewById(R.id.rcl_mem);
