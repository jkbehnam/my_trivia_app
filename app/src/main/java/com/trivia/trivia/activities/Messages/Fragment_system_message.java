...
import com.trivia.trivia.adapter.adapter_news;
...
public class Fragment_system_message extends BaseFragment {

    FragmentActivity c;
    adapter_news madapter;
    ...
    public void setItems(ArrayList<NewsArticle> eventsList) {
        ...
        madapter = new adapter_news(eventsList);
        // SlideInBottomAnimationAdapter alphaAdapter = new SlideInBottomAnimationAdapter(madapter);
        // alphaAdapter.setFirstOnly(true);
        rcle.setAdapter(madapter);
        madapter.setOnCardClickListner(new adapter_news.OnCardClickListner() {
            @Override
