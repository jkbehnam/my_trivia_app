...
public class FragmentMySellQuestion_list extends BaseFragment implements ISellquestionview {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter.setOnCardClickListner(new sellPaginationAdapter.OnCardClickListner() {
            ...
            public void OnCardClicked(View view, int position, SellQuestion q) {
                ...
                ad = dt.init(getActivity(),"میخوای از بازار برش داری؟");
        ...
        fragmentSellQuestionsPresenter = new FragmentSellQuestionsPresenter(this,false);
        ...
        fragmentSellQuestionsPresenter.refreshMyEventList(PAGE_START);
        return rootView;
