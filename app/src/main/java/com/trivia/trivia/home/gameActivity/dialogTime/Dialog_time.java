package com.trivia.trivia.home.gameActivity.dialogTime;
...
public class Dialog_time {
    ...
    public AlertDialog qrcode_reader(Context context,View view1) {
        ...
        btn_ok = (Button) view_alert_dialog_exit.findViewById(R.id.alert_btn_ok);
        pdp = (PersianDatePicker) view_alert_dialog_exit.findViewById(R.id.pdp);
