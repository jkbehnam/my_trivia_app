...
import com.trivia.trivia.adapter.adapter_my_activity_recycle;
...
public class Fragment_my_message extends myFragment {
    FragmentActivity c;
    adapter_my_activity_recycle madapter;
    ...
    public void setItems(ArrayList<NewsArticle> eventsList) {
        ...
        madapter = new adapter_my_activity_recycle(eventsList);
        // SlideInBottomAnimationAdapter alphaAdapter = new SlideInBottomAnimationAdapter(madapter);
        // alphaAdapter.setFirstOnly(true);
        rcle.setAdapter(madapter);
        madapter.setOnCardClickListner(new adapter_my_activity_recycle.OnCardClickListner() {
            @Override
