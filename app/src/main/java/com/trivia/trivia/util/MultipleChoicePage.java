...
public class MultipleChoicePage extends Question{
    ...
    public MultipleChoicePage(String Q_title, String Q_type, String Q_lang, String Q_id, String Q_img,String Q_score) {
        super(Q_title, Q_type, Q_lang, Q_id, Q_img,Q_score);
    }
