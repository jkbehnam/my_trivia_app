...
ImageView iv_title;
    ...
    public adapter_news(ArrayList<NewsArticle> data_services_list) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
      ...
      /*  if (data_service.getCode() == 0) {
       ...
       // new DownloadImageTask((ImageView) holder.iv_title).execute(data_service.getUrlToImage_small());
        Glide.with(context).load(data_service.getUrlToImage_small()).into(holder.iv_title);
