 ...
 */
public class adapter_event_show_more extends RecyclerView.Adapter<adapter_event_show_more.MyViewHolder> {
...
ImageView iv_event_type;
    ...
    public adapter_event_show_more(ArrayList<Event> data_services_list) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        try {
            ...
            uel.add(new list_item("شروع دلخواه", "placeholder", "محل برگزاری"));
        }
        ...
        if (Integer.parseInt(data_event.getE_reg_deadline())<cal.getTimeInMillis()/1000) {
            ...
            holder.cv_event.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ad = dt.init(context1,"مهلت ثبت نام در رویداد به پایان رسیده است.",data_event.getE_id());
