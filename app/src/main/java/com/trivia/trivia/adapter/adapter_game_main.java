 ...
 */
public class adapter_game_main extends RecyclerView.Adapter<adapter_game_main.MyViewHolder> {
    ...
    public adapter_game_main(ArrayList<GameMenu> data_services_list) {
