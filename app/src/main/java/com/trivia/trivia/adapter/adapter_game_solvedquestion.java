 ...
 */
public class adapter_game_solvedquestion extends RecyclerView.Adapter<adapter_game_solvedquestion.MyViewHolder> {
...
View lyt_parent;
    ...
    public adapter_game_solvedquestion(ArrayList<Question> data_services_list) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        uel.add(new list_item(data_event.getQ_type(),"effort2","نوع سوال",Integer.parseInt(data_event.getQ_level())));
    ...
    public void toggleSelection(int pos) {
        ...
        if (selected_items.get(pos, false)) {
            score-=Integer.parseInt(data_event_list.get(pos).getQ_score());
