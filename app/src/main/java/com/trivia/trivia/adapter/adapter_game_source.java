 ...
 */
public class adapter_game_source extends RecyclerView.Adapter<adapter_game_source.MyViewHolder> {
    ...
    public adapter_game_source(ArrayList<obj_film> data_services_list) {
