 ...
 */
public class adapter_event_items_main extends RecyclerView.Adapter<adapter_event_items_main.MyViewHolder> {
    ...
    public adapter_event_items_main(ArrayList<list_item> data_services_list) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_question_list_main, parent, false);
