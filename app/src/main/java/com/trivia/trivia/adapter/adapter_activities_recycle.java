 ...
 */
public class adapter_activities_recycle extends RecyclerView.Adapter<adapter_activities_recycle.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            card_title = view.findViewById(R.id.title);
            // card_info = (TextView) view.findViewById(R.id.card_info);
            //  card_date = (TextView) view.findViewById(R.id.card_date);
            CV = view.findViewById(R.id.main_lay);

            iv_title = view.findViewById(R.id.imageView_news);
            textDescription4 = view.findViewById(R.id.textDescription4);
            // Toast.makeText(view.getContext(),"تست", Toast.LENGTH_SHORT).show();
        }
    }


    public adapter_activities_recycle(ArrayList<NewsArticle> data_services_list) {
